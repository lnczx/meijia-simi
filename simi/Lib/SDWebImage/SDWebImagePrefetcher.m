...
- (void)reportStatus
{
    int total = [self.prefetchURLs count];
    NSLog(@"Finished prefetching (%i successful, %lu skipped, timeElasped %.2f)", total - _skippedCount, (unsigned long)_skippedCount, CFAbsoluteTimeGetCurrent() - _startedTime);
}
