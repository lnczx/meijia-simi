...
+ (NSString *)serializeURL:(NSString *)baseURL params:(NSDictionary *)params
{
	...
	NSMutableString *signString = [NSMutableString stringWithString:DAZHONGAPK];
	NSMutableString *paramsString = [NSMutableString stringWithFormat:@"appkey=%@", DAZHONGAPK];
	...
	[signString appendString:DAZHONG_SECREC];
