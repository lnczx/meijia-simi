...
@implementation ZuofanPicView
@synthesize delegate = _delegate;

#define hours8_20  @"08点",@"09点",@"10点",@"11点",@"12点",@"13点",@"14点",@"15点",@"16点",@"17点",@"18点",@"19点",@"20点"
#define hours12_20 @"12点",@"13点",@"14点",@"15点",@"16点",@"17点",@"18点",@"19点",@"20点"
#define hours8_19  @"08点",@"09点",@"10点",@"11点",@"12点",@"13点",@"14点",@"15点",@"16点",@"17点",@"18点",@"19点"
#define hours12_19 @"12点",@"13点",@"14点",@"15点",@"16点",@"17点",@"18点",@"19点"
#define hours8_18  @"08点",@"09点",@"10点",@"11点",@"12点",@"13点",@"14点",@"15点",@"16点",@"17点",@"18点"
#define hours12_18 @"12点",@"13点",@"14点",@"15点",@"16点",@"17点",@"18点"
...
- (id)initWithFrame:(CGRect)frame hours:(NSInteger )hours
{
    ...
    if (self) {
        ...
        BOOL ningt18 = [self compareTimestring:@"16:00:00"];
        if (ningt18 == NO) {
            [self getDate:1];
        ...
        if (hours == 2) {
            hoursArray = [[NSMutableArray alloc]initWithObjects:hours8_20,nil];
            
            //判断大于15:30的时候去掉30分钟
            BOOL time13 = [self compareTimestring:@"15:30:00"];
            if (time13 == NO) {
            ...
            //判断大于16:00:00的时候
            BOOL night = [self compareTimestring:@"16:00:00"];
...
//                [dateArray removeObjectAtIndex:0];
            ...
            if (ningt18 == NO) {
                [self getDate:1];
                hoursArray = [[NSMutableArray alloc]initWithObjects:hours12_20, nil];
                [pickerView reloadComponent:1];
            ...
            //判断时间小于凌晨10:00的时候
            BOOL AGO = [self compareTimestring:@"10:00:00"];
            if (AGO == YES) {
...
//            }
            ...
            hoursArray = [[NSMutableArray alloc]initWithObjects:hours8_19,nil];
            
            //判断大于14:30的时候去掉30分钟
            BOOL time13 = [self compareTimestring:@"14:30:00"];
            if (time13 == NO) {
                MinutesArray = [[NSMutableArray alloc]initWithObjects:@"00分", nil];
                [pickerView reloadComponent:2];
            }
            //判断大于15:00:00的时候
            BOOL night = [self compareTimestring:@"15:00:00"];
            BOOL ningt18 = [self compareTimestring:@"18:00:00"];
            if (night == NO) {
                NSLog(@"大于16:00");
                hoursArray = [[NSMutableArray alloc]initWithObjects:hours8_19,nil];
...
//                [dateArray removeObjectAtIndex:0];
            ...
            //判断大于18:00:00的时候只能下第二天12点以后的单子
            if (ningt18 == NO) {
                hoursArray = [[NSMutableArray alloc]initWithObjects:hours12_19, nil];
                [pickerView reloadComponent:1];
            ...
            //判断时间小于凌晨09:00的时候
            BOOL AGO = [self compareTimestring:@"09:00:00"];
            if (AGO == YES) {
        ...
        {
            hoursArray = [[NSMutableArray alloc]initWithObjects:hours8_18,nil];
...
//                [dateArray removeObjectAtIndex:0];
            ...
            //判断大于18:00:00的时候只能下第二天12点以后的单子
            if (ningt18 == NO) {
                hoursArray = [[NSMutableArray alloc]initWithObjects:hours12_18, nil];
                [pickerView reloadComponent:1];
            ...
            //判断时间小于凌晨08:00的时候
            BOOL AGO = [self compareTimestring:@"08:00:00"];
            if (AGO == YES) {
...
//        [dateArray removeObjectAtIndex:0];
    ...
    [self.delegate queding:[dateArray objectAtIndex:row] hours:[hoursArray objectAtIndex:row1] minutes:[MinutesArray objectAtIndex:row2]];
...
#pragma mark 获取30天的日期
-  (void)getDate:(NSInteger )day     //如果是大于18点传1   小于18点传0
{
    //获取时间
    ...
    for (int i = 0; i < 30 ; i++) {
        NSTimeInterval  interval = 24*60*60*(i+day);
...
- (void)pickerView:(UIPickerView *)pickerView2 didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    if (xiaoshi == 2 && component == 0 && row == 0) {
        hoursArray = [[NSMutableArray alloc]initWithObjects:hours8_20,nil];
...
//            [dateArray removeObjectAtIndex:0];
        ...
        if (component == 0 && row == 0) {
            ...
            if (ningt18 == NO) {
                ...
                MinutesArray = [[NSMutableArray alloc]initWithObjects:@"00分",@"30分", nil];
                [pickerView reloadComponent:2];
                if ((component == 0 && row == 0) || (component == 0 && row ==1)) {
                    return ;
                }
    ...
    }else if (xiaoshi == 3&& component == 0 && row == 0){
        hoursArray = [[NSMutableArray alloc]initWithObjects:hours8_19,nil];
...
//            [dateArray removeObjectAtIndex:0];
    ...
    }else if(xiaoshi == 4 && component == 0 && row == 0)
    {
        hoursArray = [[NSMutableArray alloc]initWithObjects:hours8_18,nil];
