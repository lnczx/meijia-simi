...
@interface JiadianThirdViewController ()<ChoiceDelegate,picDelegate,BeiZhuDelegate,userDressDelegate,CallDelegate,appDelegate>
{
...
@implementation JiadianThirdViewController
...
{
    NSString* cName = [NSString stringWithFormat:@"家电清洗3", nil];
...
- (void)viewDidLoad {
    ...
    btnRight.frame = FRAME(SELF_VIEW_WIDTH-18-18, (108/2-8)/2+(2*108/2)-3-3, 40/2, 20);
...
//        [sourceDic setObject:@"2"  forKey:@"city_id"];
        [sourceDic setObject:@"3" forKey:@"service_type"];
