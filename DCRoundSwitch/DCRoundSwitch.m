...
- (void)positionLayersAndMask
{
	...
	knobLayer.frame = CGRectMake(toggleLayer.frame.origin.x + toggleLayer.frame.size.width / 2.0 - knobLayer.frame.size.width / 2.0,-1,knobLayer.frame.size.width,knobLayer.frame.size.height);
    //knobLayer.backgroundColor=(__bridge CGColorRef)([UIColor redColor]);
}
